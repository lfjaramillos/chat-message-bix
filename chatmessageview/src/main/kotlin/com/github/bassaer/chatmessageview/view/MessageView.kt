...
class MessageView : ListView, View.OnFocusChangeListener {
    ...
    fun setMessages(messages: List<SortableMessage>) {
    ...
    */
    ...
    private fun refresh() {
        ...
        if(messageAdapter.shouldShowLoadEarlierMessages())
            chatList.add(context.getString(R.string.load_earlier_messages))
    ...
    fun setOnLoadEarlierMessagesListener(listener: Message.OnLoadEarlierMessagesListener) {
        messageAdapter.setOnLoadEarlierMessagesListener(listener)
    }
